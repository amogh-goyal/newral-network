    ...
    return (
        <div className="relative w-full min-h-screen text-white overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-950">
                ...
                <div className="relative">
                    {isSearchOpen ? (
                        ...
                        <button 
                            ...
                            className="text-xl hover:text-blue-400 transition mr-6"
                        >
                            <FaSearch />
                        </button>
                    )}
            ...
            <AnimatePresence>
                {showDashboard && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex" onClick={() => setShowDashboard(false)}>
                        <motion.div
                            className="w-72 h-full bg-gray-900 p-6 shadow-lg relative border-r border-gray-800"
                            initial={{ x: "-100%" }}
                            animate={{ x: 0 }}
                            exit={{ x: "-100%" }}
                            ...
                            {isLoading ? (
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-4">
                                        <li className="flex items-center gap-3 hover:text-blue-500 transition cursor-pointer p-2 rounded hover:bg-gray-800">
                                ...
                                <div className="flex flex-col items-center space-y-4">
                                    ...
                                    <button 
                                        onClick={() => window.location.href = "/signin"}
                                        className="w-full bg-gray-800 hover:bg-gray-700 py-3 rounded text-center transition"
                                    >
                                        Sign In
                                    </button>
                                </div>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="flex border-b border-gray-800">
                                <button 
                                    className={`flex-1 py-3 px-4 font-medium flex items-center justify-center gap-2 ${settingsTab === 'username' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-400 hover:text-white'}`}
                                    onClick={() => {
                                ...
                                <button 
                                    className={`flex-1 py-3 px-4 font-medium flex items-center justify-center gap-2 ${settingsTab === 'password' ? 'text-blue-500 border-b-2 border-blue-500' : 'text-gray-400 hover:text-white'}`}
                                    onClick={() => {
                                ...
                                <button 
                                    className={`flex-1 py-3 px-4 font-medium flex items-center justify-center gap-2 ${settingsTab === 'delete' ? 'text-red-500 border-b-2 border-red-500' : 'text-gray-400 hover:text-white'}`}
                                    onClick={() => {
                            ...
                            {settingsMessage.text && (
                                <div className={`mx-6 mt-4 p-3 rounded-lg ${settingsMessage.type === 'success' ? 'bg-green-900 text-green-200' : 'bg-red-900 text-red-200'} flex items-center gap-2`}>
                                    ...
                                    <form onSubmit={handleUsernameUpdate} className="space-y-4">
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                value={user?.username || ""} 
                                                disabled 
                                                className="w-full bg-gray-800 text-white px-4 py-2 rounded border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60"
                                            />
                                        </div>
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-gray-800 text-white px-4 py-2 rounded border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                required
                                                minLength={3}
                                            />
                                        </div>
                                        <button 
                                            type="submit" 
                                            className="w-full bg-blue-600 hover:bg-blue-700 py-2 rounded font-medium transition flex items-center justify-center"
                                    ...
                                    <form onSubmit={handleDeleteAccount} className="space-y-4">
                                        <div className="bg-red-900 bg-opacity-30 p-4 rounded-lg border border-red-800 mb-4">
                                            ...
                                            <p className="text-gray-300 text-sm">
                                                Deleting your account will permanently remove all your data, including roadmaps and progress.
                                            </p>
                                        </div>
                                        <div>
                                        ...
                                        <button 
                                            type="submit" 
                                            className="w-full bg-red-600 hover:bg-red-700 py-2 rounded font-medium transition flex items-center justify-center"
            ...
            <main className="relative flex flex-col items-center justify-center text-center pt-32 px-6 mt-16">
                ...
                >
                    <h1 className="text-5xl md:text-6xl font-extrabold mb-6 tracking-wide bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 max-w-lg mx-auto">
                        <motion.button
                            className="bg-blue-600 hover:bg-blue-700 px-6 py-4 text-lg rounded-lg shadow-lg flex items-center justify-center gap-2 font-semibold transition transform hover:-translate-y-1"
                        ...
                        <motion.button
                            className="bg-gray-800 hover:bg-gray-700 px-6 py-4 text-lg rounded-lg shadow-lg flex items-center justify-center gap-2 font-semibold transition transform hover:-translate-y-1"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            onClick={() => window.location.href = "/roadmaps"}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        {[
                            { 
                                ...
                                title: "Choose Topic", 
                                desc: "Select your desired learning area, language, and budget" 
                            },
                            { 
                                icon: <FaRoad className="text-3xl" />, 
                                title: "Get Roadmap", 
                                desc: "Receive a personalized learning path with curated resources" 
                            },
                            { 
                                icon: <FaChartPie className="text-3xl" />, 
                                title: "Track Progress", 
                                desc: "Follow your roadmap and mark courses as completed" 
                            }
                        ].map((step, index) => (
                            <motion.div 
                                key={index} 
                            ...
                            >
                                <div className="bg-blue-600 rounded-full w-20 h-20 flex items-center justify-center mb-6 shadow-lg relative">
            ...
            {/* Featured Platforms */}
            <section className="mt-24 px-6 py-12 bg-gray-900 bg-opacity-70">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-12">
                        {["Udemy", "YouTube", "Coursera", "edX", "Khan Academy", "Pluralsight"].map((platform, i) => (
                            <motion.div 
                                ...
                                transition={{ duration: 0.5 }}
                                className="text-xl font-bold text-gray-400 hover:text-white transition duration-300"
                            >
                                {platform}
                            </motion.div>
                        ))}
            ...
            {/* Chatbot Button with Enhanced Animation and Tooltip */}
            <div className="fixed bottom-8 right-8 z-40">
                ...
                >
                    <motion.button
                        className="bg-blue-600 hover:bg-blue-700 w-16 h-16 rounded-full shadow-xl flex items-center justify-center"
